...
<head>
    ...
    <link href="/Public/Wechat/Css/animate.css" rel="stylesheet">
    ...
    <script src="/Public/Wechat/Js/common.js"></script>
        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                ...
                <div class="dropdown profile-element"> <span>
                    <img alt="image" class="img-circle" src="/Public/Wechat/Images/miao.jpg" />
                     </span>
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <li><a href="<?php echo U('Staff/lists');?>">联系我们</a>
                        </li>
            ...
            <li>
                <a href="index.html#"><i class="fa icon-globe"></i> <span class="nav-label">菜单管理</span><span class="icon-angle-down"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo U('Menu/create');?>">创建</a></li>
                    <li><a href="<?php echo U('Menu/index');?>">列表</a></li>
                </ul>
            </li>
            <li>
                <a href="index.html#"><i class="fa icon-globe"></i> <span class="nav-label">用户管理</span><span class="icon-angle-down"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo U('User/create');?>">创建</a></li>
                    <li><a href="<?php echo U('User/index');?>">列表</a></li>
                </ul>
            </li>
            <li>
                <a href="index.html#"><i class="fa icon-globe"></i> <span class="nav-label">用户分组管理</span><span class="icon-angle-down"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo U('Group/create');?>">创建</a></li>
                    <li><a href="<?php echo U('Group/index');?>">列表</a></li>
                </ul>
            </li>
        </ul>
...
<style>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/Public/Wechat/Images/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/Public/Wechat/Images/a4.jpg">
                                        </a>
                                        <div class="media-body ">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <?php if(is_array($vo['sub_button'])): $i = 0; $__LIST__ = $vo['sub_button'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                    <td>
                                                        <input type="checkbox" class="i-checks" name="input[]">
                                                    </td>
    ...
    <script src="/Public/Wechat/Js/hplus.js?v=2.2.0"></script>
