...
<style>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><?php echo ($list['username']); ?>-<?php echo ($list['date']); ?></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list['content'])): $i = 0; $__LIST__ = $list['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                  <td><?php echo ($vo["date"]); ?></td>
                                                  <td><?php echo (getWeek($vo["week"])); ?></td>
                                                  <td>
    ...
    <script>
        //导航高亮
        highlight_subnav('<?php echo U("Upbill/index");?>');
