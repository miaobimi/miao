...
<style>
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal m-t" id="signupForm" name="sub_form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="signDate" name="signDate" type="text" class="form-control layer-date" aria-required="true" aria-invalid="true" class="error" placeholder="签单日期" <?php if(I('id') != ''): ?>value="<?php echo (date('Y/m/d H:i:s',$result['signdate'])); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">时间：</label>
                                        <div class="col-sm-6">
                                            <input id="start" name="startDate" class="form-control layer-date" placeholder="外出时间" <?php if(I('id') != ''): ?>value="<?php echo (date('Y/m/d H:i:s',$result['startdate'])); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">预计用时：</label>
                                        <div class="col-sm-3">
                                            <input id="expected" name="expected" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error" placeholder="如：2h" value="<?php echo ($result['expectedtime']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">外出原因：</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" aria-required="true" required="" name="reason"><?php echo ($result['outreason']); ?></textarea>
                                        </div>
                                    </div>
                                    <?php if(in_array($result['status'],array(0,''))): ?><div class="form-group">
                                ...
                                <form class="form-horizontal m-t " id="signdownForm" name="re_form">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-6 ">
                                            ...
                                            <input  name="endDate" id="endDate" class="form-control layer-date" placeholder="回岗时间" <?php if($result['status'] == 1): ?>value="<?php echo (date('Y/m/d H:i:s',$result['enddate'])); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">提前或者晚归原因：</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="preReason"><?php if($result['status'] == 1): echo ($result['expectedreason']); endif; ?></textarea>
                                        </div>
                                    </div>
                                    <?php if(session('uid') != 5): ?><div class="form-group">
                                            <label class="col-sm-3 control-label">提交部门经理签字：</label>
                                            <div class="col-sm-9">  <?php if(is_array($data1)): $i = 0; $__LIST__ = $data1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox-inline radio i-checks"> 
                                                <input type="radio" value="<?php echo ($vo["uid"]); ?>" name="manager"><i></i><?php echo ($vo["username"]); ?>
                                                </label><?php endforeach; endif; else: echo "" ;endif; ?>                          
                                            </div>
                                        </div><?php endif; ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">提交行政总监签字：</label>
                                        <div class="col-sm-9"> <?php if(is_array($data2)): $i = 0; $__LIST__ = $data2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox-inline radio i-checks">   
                                            <input type="radio" value="<?php echo ($vo["uid"]); ?>" name="director"><i></i><?php echo ($vo["username"]); ?>
                                            </label><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </div>
                                    <?php if($result['status'] == 0): ?><div class="form-group">
                                            <div class="col-sm-8 col-sm-offset-3">
                                                <button class="btn btn-primary" type="submit">提交</button>
                                            </div>
                                        </div><?php endif; ?>
    ...
    <script>
        ...
        //导航高亮
        highlight_subnav('<?php echo U("Out/index");?>');
