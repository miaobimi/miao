...
<style>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                    ...
                                                    <td><?php echo (msubstr($vo["reason"],0,15)); ?><button style= "float:right"reason="<?php echo ($vo["reason"]); ?>" class="btn btn-info radius btn-xs reasontip">查看</button></td>
                                                    <td>
    ...
    <script>
        //导航高亮
        highlight_subnav('<?php echo U("Off/lists");?>');
