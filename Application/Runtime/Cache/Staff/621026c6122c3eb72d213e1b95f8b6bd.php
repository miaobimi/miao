...
<body>
    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="index.html#"><i class="fa icon-globe"></i> <span class="nav-label">外出</span><span class="icon-angle-down"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="index.html#"><i class="fa icon-globe"></i> <span class="nav-label">权限</span><span class="icon-angle-down"></span></a>
                <ul class="nav nav-second-level">
                                        ...
                                        <div class="ibox float-e-margins">
                                            ...
                                            <form class="form-horizontal m-t" id="commentForm" novalidate="novalidate">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input value="<?php echo ($result['title']); ?>" name="title" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <textarea name="description" class="form-control" required="" aria-required="true"><?php echo ($result['description']); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-4 col-sm-offset-3">
                                                        <a href="<?php echo U('index');?>" class="btn btn-danger">返回</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a id="sumBtn" gid="<?php echo ($result['id']); ?>" class="btn btn-primary">提交</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        $(document).ready(function () {
            ...
            $('#sumBtn').bind('click',function(){
                ...
                layer.confirm('确定提交',function(){
                    ...
                    ajaxReturn("<?php echo U('editRole');?>",{
                        gid : gid,
                        title :title,
