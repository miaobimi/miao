...
<style>
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal m-t" id="nocardForm" name="sub_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <textarea class="form-control" aria-required="true" required="" name="nocard"><?php echo ($result['outreason']); ?></textarea>
                                        </div>
                                    </div>
    ...
    <!-- chosen select -->
    <link rel="stylesheet" type="text/css" href="/Public/Static/chosen/chosen.css">
    <script type="text/javascript" src="/Public/Static/chosen/chosen.jquery.js"></script>
    <script> 
        ...
        //导航高亮
        highlight_subnav('<?php echo U("Upcard/index");?>');
