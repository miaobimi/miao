    ...
    .fixed-nav .slimScrollDiv #side-menu {
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                <div class="row">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-4">
                            <div class="contact-box">
                                <a href="profile.html">
                                    <div class="col-sm-4">
                                        <div class="text-center">
                                            <img alt="image" class="img-circle m-t-xs img-responsive" src="/Public/Staff/Images/m.jpg">
                                            <div class="m-t-xs font-bold"><?php echo ($vo["apartment"]); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                        <h3><strong><?php echo ($vo["name"]); ?></strong></h3>
                                        <p><i class="fa fa-map-marker"></i>工号：<?php echo ($vo["no"]); ?></p>
                                        <address>
