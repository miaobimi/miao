                                        ...
                                        <div class="ibox float-e-margins">
                                            <form class="form-horizontal m-t" id="commentForm" novalidate="novalidate">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input placeholder="管理员管理" name="modules_name" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">模块链接：</label>
                                                    <div class="col-sm-4">
                                                        <input placeholder="Admin/User/index" name="link" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">排序：</label>
                                                    <div class="col-sm-4">
                                                        <input name="sort" minlength="2" type="text" placeholder="数字越小越靠前" class="form-control" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
        ...
        $(document).ready(function () {
            $('#subBtn').bind('click',function(){
                layer.confirm('确定提交？',function(){
                    var modules_name = $.trim($('input[name=modules_name]').val());
                    var link = $.trim($('input[name=link]').val());
                    var sort = $.trim($('input[name=sort]').val());
                    if(modules_name =='' || link =='' || sort==''){
                        layer.alert('不能为空',{icon:2});
                        return;
                    }
                    ajaxReturn("<?php echo U('addModules');?>",{
