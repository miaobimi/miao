...
<style>
    ...
    dl.checkmod dt.hd {
        border-bottom: 3px solid #39b3d7;
        display: block;
        font-size: 14px;
        height: 30px;
        line-height: 20px;
...
<style>
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-5 m-b-xs">
                                        <select  class="input-sm form-control input-s-sm inline" name="modules_id">
                                ...
                                <div>
                                    <form name="group" action="<?php echo U('Staff/Auth/addRules',array('gid'=>I('gid')));?>" method="POST">
                                        <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl class="checkmod">
                                                <dt class="hd">
                                                    <label class="checkbox"><input class="i-checks selectedAll" type="checkbox" value="<?php echo ($vo["id"]); ?>">&nbsp;<?php echo ($vo["modules_name"]); ?></label>
                                                </dt>
                                                    ...
                                                    <ul class="rule_check">
                                                        <?php if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><li>
                                                                <label class="checkbox" >
                                                                   <input class="i-checks" <?php if(in_array($node['id'], $access)){ echo "checked='true'";} ?> type="checkbox" name="rules[]"
                                        ...
                                        <!-- <div class="form-group"> -->
                                            <!-- <div class="col-sm-offset-1 col-sm-10"> -->
                                              ...
                                              <a class="btn btn-danger" href="<?php echo U(index);?>">返回</a>
                                            <!-- </div> -->
                                        <!-- </div> -->
                                    </form>
                                </div>
    ...
    <script>
        //导航高亮
        highlight_subnav('<?php echo U("Auth/node");?>');
