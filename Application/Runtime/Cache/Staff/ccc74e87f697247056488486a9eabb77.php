        ...
        <ul class="nav" id="side-menu">
            ...
            <?php if(authcheck('Staff/Upcard/index',session('uid'))): ?><li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="<?php echo U('Upcard/alists');?>">审核</a></li>
                    </ul>
                </li><?php endif; ?>
    ...
    .fixed-nav .slimScrollDiv #side-menu {
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>为<font style="color:red;"><?php echo ($username); ?></font>指定组</a></h2>
                </div>
            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <form method="POST" action="<?php echo U('Auth/group',array('uid'=>I('uid')));?>" class="form-horizontal" role="form">
                                            <?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="checkbox">
                                                <h4>
                                                    <label>
                                                     <input class="i-checks" <?php if(in_array($vo['id'], $groupid)){echo "checked='true'";} ?> type="checkbox" name="groupid[]" value="<?php echo ($vo["id"]); ?>"> <?php echo ($vo["title"]); ?>
