...
<style>
                                        ...
                                        <div class="ibox float-e-margins">
                                            ...
                                            <form class="form-horizontal m-t" id="commentForm" novalidate="novalidate">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input placeholder="Staff/User/index" name="name" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">节点描述：</label>
                                                    <div class="col-sm-4">
                                                        <input placeholder="管理员列表" name="title" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label class="checkbox-inline i-checks">
                                                            <input name="status" checked=true value="1" type="radio">&nbsp;是
                                                        </label>
                                                        <label class="checkbox-inline i-checks">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <textarea name="condition" class="form-control" required="" aria-required="true"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-4 col-sm-offset-3">
                                                        <a href="<?php echo U('node');?>" class="btn btn-danger">返回</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a id="subBtn" class="btn btn-primary">提交</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
    ...
    <script>
        //导航高亮
        highlight_subnav('<?php echo U("Auth/addNode");?>');
        ...
        $(document).ready(function () {
            ...
            $('#subBtn').bind('click',function(){
                layer.confirm('确定提交？',function(){
                    ...
                    var condition = $.trim($('textarea').val());
                    var status = $.trim($('input[name=status]:checked').val());
                    var modules_id = $('select[name=modules_id]').val();
                    if(name =='' || title ==''){
                        layer.alert('节点名称、描述不能为空',{icon:2});
                        return;
                    }
                    ajaxReturn("<?php echo U('addNode');?>",{
                        name : name,
                        title : title,
                        status : status,
