<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <head>
	...
	<link rel="stylesheet" type="text/css" href="/Public/Binary/Css/main.css">
 	<title>中远融投－主页</title>
  	<script type="text/javascript" src="http://cdn.hcharts.cn/highcharts/highcharts.js"></script>
    <script type="text/javascript" src="http://cdn.hcharts.cn/highcharts/exporting.js"></script>
  	<script type="text/javascript" src="/Public/Binary/Js/drawline.js"></script>
 </head>
...
<script>
var historyquotes = "<?php echo U('Binary/Index/historyquotes');?>";
//websocke推数据 部分   
function ActivePushPrice(){
	try{
		socket = new WebSocket('ws://115.28.137.28:4439');
	}catch(e){
		alert('error');
		return;
	}
	socket.onopen=function (evt){
		console.log(evt);
		var EXPORT_SYMBOLS = 'XAUUSDbo,XAGUSDbo,GBPUSDbo,GBPCHFbo,EURJPYbo,USDJPYbo,EURGBPbo,AUDUSDbo,EURUSDbo,UKOilbo,USOilbo';
		// socket.send("U_L-LOGIN=6666|PWD=9cbf8a4dcb8e30682b927f352d6559a0");
		// setTimeout(function(){socket.send("G_BV");},100);   
		// setTimeout(function(){socket.send("A_OO-ACTIVE=1");},200);     //orderlist
		// setTimeout(function(){socket.send("A_T-SYMBOLS=,"+EXPORT_SYMBOLS+",|ACTIVE=1");},300); // ticks    
		// setTimeout(function(){socket.send("A_U-ACTIVE=1");},400);  
